...
const NavBarInt = (test) => {
  ...
  const logoutWithRedirect = () =>
    ...
    console.log(test.prop,'app>nav')
    console.log(test.prop.length,'total orders')

    const total_orders = test.prop.length

    const total_pending = test.prop.filter(obj => {
      return obj.status === 'pending'
    })

    const total_complete = test.prop.filter(obj => {
